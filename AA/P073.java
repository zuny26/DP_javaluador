...
public class P073{
    ...
    private int best(int m1, int m2, int i){
        if (i==N) return 0;
    ...
    public ArrayList<Integer> bestSolution(String[] data){
        ...
        while (!(i+1>=N && d<0)){
            // for (Integer x : current)System.out.print(x + " ");
            // System.out.println();
    ...
    public static void main(String[] args) {
        String data[] = {"450 1200 4096 2700", "30 40 50 60", "2500 4000"};
        // String data[] = {"5 3 7", "1 2 3", "5 7"};
        P073 problem = new P073();
        ArrayList<Integer> solution = problem.bestSolution(data);
        for (Integer x : solution)System.out.print(x + " ");
        System.out.println();
    }
}